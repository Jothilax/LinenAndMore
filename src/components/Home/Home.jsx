...
function Home() {
  ...
  return (
    <>
      {/* SEO META */}
      <Helmet>
        <title>Premium Linen Bedsheets Online in India | Linen & More</title>
        <meta
          name="description"
          content="Shop premium linen bedsheets, pillow covers & luxury linen bedding in India."
        />
      </Helmet>
      ...
      <div className={styles.home}>
        ...
        <div className={styles.hero}>
          <div className={styles.heroImg}>
            <img
              src={home1}
              alt="Premium linen textile manufacturing facility in India"
              loading="lazy"
            />
          </div>
          ...
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.head}>
              Premium Linen Bedsheets & Home Furnishings in India
            </h1>
            ...
            {/* ✅ SEO PARAGRAPH ABOVE THE FOLD */}
            <p>
              Linen & More is a premium textile brand in India specializing in
              luxury linen bedsheets, pillow covers, and home furnishings.
              Our products are crafted using breathable, natural fabrics
              designed for comfort, durability, and timeless elegance.
            </p>
        ...
        <div className={styles.product}>
          ...
          <div className={styles.prdImg}>
            <img src={p1} alt="Luxury linen bedsheets for hotels and homes" loading="lazy" />
            <img src={p2} alt="Premium linen pillow covers in India" loading="lazy" />
            <img src={p3} alt="High quality linen fabric products" loading="lazy" />
            <img src={p4} alt="Durable hospitality linen textiles" loading="lazy" />
            <img src={p5} alt="Elegant linen bedding collection" loading="lazy" />
            <img src={p6} alt="Premium linen home furnishing products" loading="lazy" />
          </div>
        </div>
